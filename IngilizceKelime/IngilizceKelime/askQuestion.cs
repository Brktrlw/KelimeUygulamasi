...
namespace IngilizceKelime
{
    public partial class askQuestion : Form
    {
        ...
        private void txt_trKelime_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                btnKelimeEkle_Click(this.txt_trKelime, e);
            }
        }

        private void txt_ingKelimeEkle_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                btnKelimeEkle_Click(this.txt_ingKelimeEkle, e);
            }
        }
    }
}
